...
def main(arguments):
    ...
    parser.add_argument('--plot', action='store_true',
                        help="Plot graph (visual map of the test case)", required=False)
    parser.add_argument('-f', '--file',
                        help="Print testcase details in files starting with this suffix + (_graph.txt, _data.txt, _plot.png)",
                        required=False)
